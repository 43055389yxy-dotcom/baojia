...
const PROVIDER_SCENARIO_LABELS = Object.freeze({
  ...
  alibaba_intl: { on_demand: '按量付费', one_month_subscription: '包月', one_year_subscription: '包年（1 年）' },
  huawei: { on_demand: '按需计费', one_month_subscription: '包月', one_year_subscription: '包年（1 年）' },
  huawei_intl: { on_demand: '按需计费', one_month_subscription: '包月', one_year_subscription: '包年（1 年）' },
